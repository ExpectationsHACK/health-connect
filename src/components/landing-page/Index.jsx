...
function Index() {
  const features =[{title: "AI Symptom Checkers", description: "Get instant health insights powered by advanced AI"}, {title: "Doctor Matching", description: "Find the right specialist for your needs for consultation"}, {title: "Smart Reminders", description: "Never miss your medications again. Get notifications on your next medication"},]
  return (
    <VStack w="100%" h="100vh" justify="flex-start" align="flex-start" gap="100px">
      <TopNav/>
